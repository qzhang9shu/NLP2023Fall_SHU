...
if __name__ == '__main__':
    ...
    parser.add_argument('--word-map', '-wm', help='path to word map JSON')
    parser.add_argument('--beam-size', '-b', default=5, type=int, help='beam size for beam search')
    parser.add_argument('--dont-smooth', dest='smooth', action='store_false',
    ...
    seq, alphas = caption_image_beam_search(device, encoder, decoder, args.img, word_map, args.beam_size)
